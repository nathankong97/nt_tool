...
def process_date(dates):
    ...
    segments = []
    for date in dates:
        result = ua.search2("JFK", "HND", date, proxy.proxy_ip)
...
nested_dates = [
    [{'date': '2023-11-01'}, {'date': '2023-11-02'}, {'date': '2023-11-03'}, {'date': '2023-11-04'},
     {'date': '2023-11-05'}, {'date': '2023-11-06'}],
    [{'date': '2023-11-07'}, {'date': '2023-11-08'}, {'date': '2023-11-09'}, {'date': '2023-11-10'},
     {'date': '2023-11-11'}, {'date': '2023-11-12'}],
    [{'date': '2023-11-13'}, {'date': '2023-11-14'}]]

with Pool() as pool:
    result = pool.starmap(process_date, nested_dates)
...
def main():
    ...
    for date in formatted_dates:
        result = ua.calendar_search(date, "NYC", "TYO", proxy.proxy_ip)
    ...
    print(lowest_award_dates)

    # SEARCH LIST OF LOWEST AWARD TICKETS IN SPECIFIC DATES
    date_keys = [next(iter(entry)) for entry in lowest_award_dates]
    max_dates_per_list = 6
    nested_dates = [date_keys[i:i + max_dates_per_list] for i in range(0, len(date_keys), max_dates_per_list)]
    segments = []
